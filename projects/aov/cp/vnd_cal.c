 ...
 * pwr_gain<25:22> Gmgain in TRX_C<3:0>, 2 at present
...
const TXPWR_CAL_ST gtxpwr_tab_def_b[TXPWR_CAL_2G_MAX] = {
    INIT_TXPWR_VALUE(1, 41),  // ch1  inused
    INIT_TXPWR_VALUE(7, 39),  // ch7  inused
    INIT_TXPWR_VALUE(13, 38),  // ch13  inused
};

const TXPWR_CAL_ST gtxpwr_tab_def_g[TXPWR_CAL_2G_MAX] = {
    INIT_TXPWR_VALUE(1, 81),  // ch1  inused
    INIT_TXPWR_VALUE(7, 80),  // ch7  inused
    INIT_TXPWR_VALUE(13, 78),  // ch13  inused
};
