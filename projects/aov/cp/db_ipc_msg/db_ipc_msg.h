...
#define DB_BK7259_VERSION "999.999.999.999"

typedef enum{
    DB_IPC_CMD_KEEPALIVESTART             = 0x0002,
    DB_IPC_CMD_KEEPALIVESTOP              = 0x0003,
    DB_IPC_CMD_GET_WAKEUP_ENV_ADDR        = 0x0004,
    DB_IPC_CMD_AOV_GET_SHARED_ENV_ADDR    = AOV_IPC_CMD_GET_SHARED_ENV_ADDR,
    DB_IPC_CMD_AOV_AP_REPORT              = AOV_IPC_CMD_AP_REPORT,
