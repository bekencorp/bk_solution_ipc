...
#define DB_KEEPALIVE_CP_BIND_PORT_START  0x1000
#define DB_KEEPALIVE_CP_BIND_PORT_END    0x1010
#define DB_KEEPALIVE_CP_BIND_PORT_COUNT  (DB_KEEPALIVE_CP_BIND_PORT_END - DB_KEEPALIVE_CP_BIND_PORT_START + 1)
